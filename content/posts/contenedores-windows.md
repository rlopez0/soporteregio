---
title: "Contenedores ¿Windows?"
date: "2024-04-03T19:23:13-06:00"
# weight: 1
# aliases: ["/first"]
tags: ["contenedores","docker","linux","productividad","tecnología","windows"]
author: "El Admin"
...
UseHugoToc: true
cover:
    image: "/images/contenedores1.webp" # image path/url
...
{{< figure src="/images/contenedores2.webp" width="600" height="600" align=center alt="Infografía Windows en Contenedores" caption="Infografía Windows en Contenedores" >}}

Imagina un mundo donde instalar, ejecutar y cambiar entre diferentes aplicaciones y entornos de trabajo es tan fácil como cambiar de zapatos. ¿Necesitas zapatillas para correr? ¡Listo! ¿Botas para la lluvia? ¡Ahí están! Así es como [Docker](https://www.docker.com), especialmente en Windows, está revolucionando nuestras tareas cotidianas de productividad: haciendo que el cambio entre diferentes "calzados" tecnológicos sea un juego de niños.
...
{{< figure src="/images/contenedores4.webp" width="500" height="500" align=center alt="Cocina de Contenedores" caption="Cocina de Contenedores" >}}

## Docker en Windows: Un Guardarropa Para Todas las Estaciones

{{< figure src="/images/contenedores5.webp" width="500" height="500" align=center alt="Guardaropa versatil" caption="Guardaropa versatil" >}}
...
{{< figure src="/images/contenedores7.webp" align=center caption="Contenedores; el éxito a la productividad" >}}

_En una siguiente parte hablaré propiamente de como configurar este entorno para utilizar Windows en docker específicamente._